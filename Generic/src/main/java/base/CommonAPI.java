...
public class CommonAPI {
    ...
    public static WebDriver getLocalDriver(String browserName, String platform) {
        if (platform.equalsIgnoreCase("mac") && browserName.equalsIgnoreCase("chrome")) {
            System.setProperty("webdriver.chrome.driver", "/Users/mac/Documents/weekdays/BootCamp/Generic/src/main/resources/chromedriver");
        } else if (platform.equalsIgnoreCase("windows") && browserName.equalsIgnoreCase("chrome")) {
            System.setProperty("webdriver.chrome.driver", "/Users/mac/Documents/weekdays/BootCamp/Generic/src/main/resources/chromedriver.exe");
        }
    ...
    //added perform to action
    public void mouseHoverByXpath(WebElement element) {
        try {
